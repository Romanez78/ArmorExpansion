...
//-------------------------------------
instance Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS (C_INFO)
{
	npc			 =  MIL_314_MORTIS;
	nr			 =  4;
	condition	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_Condition;
	information	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_Info;
	permanent	 = 	FALSE;
	description	 = 	"ChtÏl bych vylepöit lehkou zbroj";
};
func int Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_Condition ()
{	
...
func void Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_Info ()
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_15_01"); //ChtÏl bych vylepöit lehkou zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_15_04"); //Co na to budeö pot¯ebovat?.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_13_06"); //Na lehkou zbroj bude staËit jeden ocelov˝ prut a kanËÌ k˘ûe.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_13_07"); //A ¯eknÏme ûe 200 zlat˝ch mi bude za tu pr·ci staËit.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_13_08"); //A samozrejmÏ mi budeö muset taky p¯inÈst tu zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS_15_09"); //Dobr·, pokusÌm se to sehnat.
...
//-------------------------------------
instance Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LReforgedArmor (C_INFO)
{
	npc			 =  MIL_314_MORTIS;
	nr			 =  4;
	condition	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LReforgedArmor_Condition;
	information	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LReforgedArmor_Info;
	permanent	 = 	TRUE;
	description	 = 	"M·m vöechny pot¯ebnÈ materi·ly na vylepöenÌ lehkÈ zbroje.";
};
func int Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LReforgedArmor_Condition ()
{	
	...
	&& (Npc_KnowsInfo (other, Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LTHINGS))
	{
		return TRUE;
	};
};
func void Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MIL_LReforgedArmor_Info ()
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_LREFORGEDARMOR_15_01"); //M·m vöechny pot¯ebnÈ materi·ly na vylepöenÌ lehkÈ zbroje.
	...
	{	
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_LREFORGEDARMOR_13_12"); //Dob¯e, d·m se tedy do pr·ce.
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_LREFORGEDARMOR_13_13"); //Hotovo.
        B_GiveInvItems(self, other, ITAR_MIL_R_ArmorExpansion, 1);
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_LREFORGEDARMOR_13_14"); //Tady ji m·ö, docela se mi povedla ¯ekl bych.
        AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_LREFORGEDARMOR_15_15"); //DÌky.
		B_LogEntry (TOPIC_NINJA_ARMOREXPANSION_MORTIS_ARMOR,"Mortis mi vylepöil lehkou zbroj.");
	}
	else 
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_LREFORGEDARMOR_13_16"); //Vraù se aû to vöechno budeö mÌt u sebe.
	};
};
//-------------------------------------
var int Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH;
//-------------------------------------
instance Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH (C_INFO)
{
	npc			 =  MIL_314_MORTIS;
	nr			 =  8;
	condition	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_Condition;
	information	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_Info;
	permanent	 = 	FALSE;
	description	 = 	"ChtÏl bych vylepöit st¯ednÌ zbroj";
};
func int Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_Condition ()
{	
...
func void Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_Info ()
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_15_01"); //ChtÏl bych vylepöit st¯ednÌ zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_15_03"); //Co na to budeö pot¯ebovat?.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_13_04"); //Na st¯ednÌ zbroj si budeö muset p¯inÈst o nÏco vÌc.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_13_05"); //dva ocelovÈ pruty a k˘ûi z Warga.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_13_06"); //Budu za tu pr·ci chtÌt 600 zlat˝ch.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH_15_08"); //Dobr·, pokusÌm se to sehnat.
...
//-------------------------------------
instance Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumArmor (C_INFO)
{
	npc			 =  MIL_314_MORTIS;
	nr			 =  8;
	condition	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumArmor_Condition;
	information	 = 	Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumArmor_Info;
	permanent	 = 	TRUE;
	description	 = 	"M·m vöechny pot¯ebnÈ materi·ly na vylepöenÌ st¯ednÌ zbroje.";
};
func int Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumArmor_Condition ()
{	
	...
	&& (Npc_KnowsInfo (other, Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumHUH))
	{
		return TRUE;
	};
};
func void Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MILITIA_MediumArmor_Info ()
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_15_01"); //M·m vöechny pot¯ebnÈ materi·ly na vylepöenÌ st¯ednÌ zbroje.
	...
	{	
        ...
        AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_15_10"); //Tady to je.
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_13_11"); //Dob¯e, d·m se tedy do pr·ce.
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_13_12"); //Hotovo.
        Patch_ArmorExpansion_MORTIS_MILITIA_MediumArmorBought = B_GiveInvItems(self, other, ITAR_MIL_Med2_ARMOREXPANSION, 1);
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_13_13"); //Tady ji m·ö, docela se mi povedla ¯ekl bych.
        AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_15_14"); //DÌky.
				B_LogEntry (TOPIC_NINJA_ARMOREXPANSION_MORTIS_ARMOR,"Mortis mi vylepöil st¯ednÌ zbroj.");
	}
	else 
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_Patch_ArmorExpansion_MORTIS_MediumArmor_13_16"); //Vraù se aû to vöechno budeö mÌt u sebe.
	};
};
//-------------------------------------
...
instance Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar		(C_INFO)
{
	npc		 = 	KDF_502_Ulthar;
	nr		 = 	30;
	condition	 = 	Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_Condition;
	information	 = 	Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_Info;
	important	 =	TRUE;

	description  = 	"VyËistil jsem vöechny svatinÏ.";
};

func int Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_Condition ()
{
...
func void Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_Info ()
{
	AI_Output			(self, other, "Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_05_01"); //PoËkej, chtÏli jsme tÏ jeötÏ podpo¯it v tvÈm boji proti zlu novou zbrojÌ.
	AI_Output			(self, other, "Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_05_02"); //Vezmi si tuhle zbroj k¯iû·ka Innose, jsem si jist˝ ûe ji vyuûijeö.
	AI_Output			(other, self, "Ninja_ArmorExpansion_DIA_PATCH_ARMOREXPANSION_Ulthar_05_03"); //DÏkuji.
...
//-----------------------------
var int Bennet_Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CM_permanent;
//-----------------------------
...
{
	IF (Bennet_Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CM_permanent == FALSE)
	&& (hero.guild == GIL_DJG)
...
{	
	...
	if (Npc_HasItems (other,itmi_Gold) >= 12000)
	{
		...
		Bennet_Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CM_permanent = TRUE;
	}
	else
	{
...
//---------------------------------------------------
var int Bennet_Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CH_permanent;
//---------------------------------------------------
...
{
	IF (Bennet_Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CH_permanent == FALSE)
	&& (hero.guild == GIL_DJG)
...
{	
	...
	if (Npc_HasItems (other,itmi_Gold) >= 20000)
	{
		...
		Bennet_Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CH_permanent = TRUE;
	}
	else
	{
