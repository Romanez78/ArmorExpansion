...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BRIAN_BUYRAWSTEEL_PATCHOC_15_01"); //Potřebuju více surové oceli.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BRIAN_BUYRAWSTEEL_PATCHOC_13_02"); //Můžu ti prodat nějáke z mých osobních zásob, ale vyjde tě to draho.
...
func void Ninja_ArmorExpansion_DIA_PATCHOC_BRIAN_IWANNABUYSOMESTEEL_Info ()
{
	...
	{
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_PATCHOC_BRIAN_IWANNABUYSOMESTEEL_4_3"); //Přijď až budeš mít u sebe dost zlata
	};
};
//-------------------------------------
...
{
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Matteo_LEATHER_15_00"); //Dobře, dej mi tu zbroj.
	...
	{
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Matteo_LEATHER_09_02"); //Ta zbroj má svojí cenu - a taky za ní stojí takže se vrať až budeš mít dost zlata.
	};
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_ARMORQUESTION_15_01"); //Nemáš pro mně nějakou lepší zbroj?
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_ARMORQUESTION_13_02"); //Jedině Lord Andre ti může dát lepší zbroj.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_ARMORQUESTION_13_03"); //Ale to neznamená že ti nemůžu trochu vylepšit tu co už máš, nebyl by jsi první komu jsem to dělal.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_ARMORQUESTION_15_04"); //Co to bude stát?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_ARMORQUESTION_13_05"); //Budeš si muset přinést materiál, já tu žádný na zbyt nemám.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_ARMORQUESTION_13_06"); //A nějáké zlato za mojí práci.
	Log_CreateTopic (NINJA_ARMOREXPANSION_TOPIC_MORTIS_ARMOR,LOG_NOTE);
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MORTIS_ARMOR,"Mortis mi může vylepšit zbroje domobrany když mu přinesu materiály a zlato.");
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MIL_LTHINGS_15_01"); //Chtěl bych vylepšit lehkou zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MIL_LTHINGS_15_04"); //Co na to budeš potřebovat?.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MIL_LTHINGS_13_06"); //Na lehkou zbroj bude stačit jeden ocelový prut a kančí kůže.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MIL_LTHINGS_13_07"); //A řekněme že 200 zlatých mi bude za tu práci stačit.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MIL_LTHINGS_13_08"); //A samozrejmě mi budeš muset taky přinést tu zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MIL_LTHINGS_15_09"); //Dobrá, pokusím se to sehnat.
		B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MORTIS_ARMOR,"Na vylepšení lehké zbroje bude Mortis potřebovat jeden ocelový prut, kančí kůži a 200 zlatých.");
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_LREFORGEDARMOR_15_01"); //Mám všechny potřebné materiály na vylepšení lehké zbroje.
	...
	if (Npc_HasItems(other,ItAr_MIL_L) >= 0) && (Npc_HasItems(other,ItMiSwordraw) >= 1) && (Npc_HasItems(other,ItAt_Addon_KeilerFur) >= 1) && (Npc_HasItems(other,ItMi_Gold) >= 200)
	{
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_LREFORGEDARMOR_13_12"); //Dobře, dám se tedy do práce.
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_LREFORGEDARMOR_13_14"); //Tady ji máš, docela se mi povedla řekl bych.
	...
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_MORTIS_LREFORGEDARMOR_13_16"); //Vrať se až to všechno budeš mít u sebe.
	};
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MILITIA_MediumHUH_15_01"); //Chtěl bych vylepšit střední zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MILITIA_MediumHUH_15_03"); //Co na to budeš potřebovat?.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MILITIA_MediumHUH_13_04"); //Na střední zbroj si budeš muset přinést o něco víc.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MILITIA_MediumHUH_13_05"); //dva ocelové pruty a kůži z Warga.
	...
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MILITIA_MediumHUH_15_08"); //Dobrá, pokusím se to sehnat.
		B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MORTIS_ARMOR,"Na vylepšení střední zbroje bude Mortis potřebovat dva ocelové pruty, kůži z Warga a 600 zlatých.");
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MediumArmor_15_01"); //Mám všechny potřebné materiály na vylepšení střední zbroje.
    ...
    && (Npc_HasItems(other, ItMi_Gold) >= 600)
	{
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MediumArmor_13_11"); //Dobře, dám se tedy do práce.
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MediumArmor_13_13"); //Tady ji máš, docela se mi povedla řekl bych.
        AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MORTIS_MediumArmor_15_14"); //Díky.
				B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MORTIS_ARMOR,"Mortis mi vylepšil střední zbroj.");
	}
	else
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_MORTIS_MediumArmor_13_16"); //Vrať se až to všechno budeš mít u sebe.
	};
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_ANDRE_MIL_SCOUTARMOR_15_01"); //Nenašla by se pro mně lehhčí zbroj?.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_ANDRE_MIL_SCOUTARMOR_15_02"); //Radši používám zbraně na dálku.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_ANDRE_MIL_SCOUTARMOR_13_03"); //Můžu ti vyměnit tvojí zbroj za zbroj zvěda. Je lehčí než standartní výbava takže budeš obratnější, ale i zranitelnější
    ...
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_ANDRE_MIL_SCOUTARMOR_15_9");//Tady máš, ať ti slouží dobře.
};
//-------------------------------------
...
func void Ninja_ArmorExpansion_DIA_ANDRE_MILITIA_ARMORREWARD_Info ()
{
		...
		AI_Output (self,other,"Ninja_ArmorExpansion_DIA_ANDRE_MILITIA_ARMORREWARD_01_05"); //Tady máš, střední zbroj domobrany.
		AI_Output (self,other,"Ninja_ArmorExpansion_DIA_ANDRE_MILITIA_ARMORREWARD_01_06"); //Ať ti slouží vojáku.
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_LEE_SLD_SCOUTArmor_15_01"); //Nenašla by se pro mně lehhčí zbroj?.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_LEE_SLD_SCOUTArmor_15_02"); //Radši používám zbraně na dálku.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_LEE_SLD_SCOUTArmor_13_03"); //Já nic takového pro tebe nemám, ale nejsi první kdo něco takového chce
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_LEE_SLD_SCOUTArmor_13_04"); //Jdi za Wolfem, myslím si že on by měl pro tebe něco mít
};
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_WOLF_SLD_SCOUTArmorBought_15_01"); //Slyšel jsem že děláš zbroje pro zvědy.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_WOLF_SLD_SCOUTArmorBought_15_02"); //chtěl bych si vyměnit tu co mám teď
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_WOLF_SLD_SCOUTArmorBought_13_03"); //Jistě, zrovna jsem jednu dokončil. Můžeš ji mít zadarmo, kvůli starým časům.
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_SLDARMORASK_15_01"); //Můžeš mi prodat nějakou lepší zbroj?.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLDARMORASK_13_02"); //Ne, zbroje může rozdávat jenom Lee.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLDARMORASK_13_03"); //Můžu ti ale vylepšit tu co jsi už dostal, ale budu za to něco chtít.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_SLDARMORASK_15_04"); //A to?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLDARMORASK_13_05"); //Material na výrobu, ten si přineseš sám, nebudu ti to dělat ze svých zásob.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLDARMORASK_13_07"); //A nepracuju zadarmo, takže si taky připrav nějáké zlato.
		Log_CreateTopic (NINJA_ARMOREXPANSION_TOPIC_BENNET_ARMOR,LOG_NOTE);
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_BENNET_ARMOR,"Bennet mi může vylepšit zbroje žoldáka když mu přinesu materiály a zlato.");
};
...
func void Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedHUH_Info ()
{
	...
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedHUH_15_04"); //Co na to potřebuješ?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedHUH_13_06"); //Na lehkou zbroj ti postačí dva ocelové pruty a dvě vlčí kůže.
	...
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedHUH_15_09"); //Dobrá.
		B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_BENNET_ARMOR,"Na vylepšení lehké zbroje bude Bennet potřebovat dva ocelové pruty, dvě kůže z vlka a 200 zlatých.");
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedArmor_15_01"); //Mám všechny potřebné materiály na vylepšení lehké zbroje.
    ...
    && (Npc_HasItems(other, ItMi_Gold) >= 200)
	{
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedArmor_13_12"); //Dobře, tak se na to podívejme.
	...
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_BENNET_SLD_LReforgedArmor_13_16"); //Vrať se až to všechno budeš mít.
	};
};
...
func void Ninja_ArmorExpansion_DIA_Engor_RSkaufen_Info ()
{
	if (B_GiveInvItems (other, self, Itmi_Gold,2500))
	{
		...
		AI_Output (self, other, "Ninja_ArmorExpansion_DIA_Engor_RSkaufen_13_01"); //Tady ji máš, dobře tě ochrání, je to zatraceně dobrý kousek.
		B_GiveInvItems (self,other, Ninja_ArmorExpansion_ITAR_MIL_H,1);
		Ninja_ArmorExpansion_DIA_Engor_RSkaufen_perm = TRUE;
	}
	else
	{
		AI_Output (self, other, "Ninja_ArmorExpansion_DIA_Engor_RSkaufen_13_02"); //Nejdřív mi přines to zlato.
	};
};
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedHUH_15_01"); //Chci si nechat vylepšit střední zbroj.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedHUH_15_03"); //Co na to potřebuješ?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedHUH_13_04"); //Na střední zbroj toho bude potřeba víc.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedHUH_13_05"); //Tři ocelový pruty, a jednu kůži z Warga.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedHUH_13_06"); //Za výrobu budu chtít, řekněme 650 zlatých.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedHUH_15_08"); //Dobrá.
			B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_BENNET_ARMOR,"Na vylepšení střední zbroje bude Bennet potřebovat tři ocelové pruty, jednu kůži ze skřetího psa, dvě kůže z trolla a 650 zlatých.");
};
//-------------------------------------
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedArmor_15_01"); //Mám všechny potřebné materiály na vylepšení střední zbroje.
    ...
    && (Npc_HasItems(other, ItMi_Gold) >= 650)
	{
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedArmor_13_11"); //Dobře, tak se na to podívejme.
		...
		B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MORTIS_ARMOR,"Bennet mi vylepšil střední zbroj.");
	}
	else
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_BENNET_MERC_MReforgedArmor_13_16"); //Vrať se až to všechno budeš mít u sebe.
	};
};
...
{
	AI_Output			(self, other, "Ninja_ArmorExpansion_DIA_Ulthar_05_01"); //Počkej, chtěli jsme tě ještě podpořit v tvém boji proti zlu novou zbrojí.
	AI_Output			(self, other, "Ninja_ArmorExpansion_DIA_Ulthar_05_02"); //Vezmi si tuhle zbroj křižáka Innose, jsem si jistý že ji využiješ.
	AI_Output			(other, self, "Ninja_ArmorExpansion_DIA_Ulthar_05_03"); //Děkuji.
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Lord_Hagen_CROSSBOW_15_01"); //Nenašla by se pro mně lehčí zbroj?.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Lord_Hagen_CROSSBOW_15_02"); //Radši používám zbraně na dálku.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Lord_Hagen_CROSSBOW_13_03"); //Můžu ti vyměnit tvojí rytířskou zbroj za odlehčenou variantu, určenou pro kušišníky.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Lord_Hagen_CROSSBOW15_04"); //Beru jí.
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Lord_Hagen_CROSSBOW_15_9");//Nos ji se ctí, rytíři.
};
//-------------------------------------
const string	NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR				=   "Vyjímečná Paladinská zbroj";
//-------------------------------------
...
func void Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_Info ()
{
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_3_02"); //Možná bych to pro tebe měl něco zvláštního
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_3_03"); //O čem to mluvíš?
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_3_04"); //Mám tu na skladě výjimečnou paladinskou zbroj.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_3_05"); //Slyšel jsem že tenhle typ zbroje má vysokou ochranu proti magickým útokům
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_3_06"); //Ale už tu nejáký čas leží, a pobřežní počasí jí neudělalo dobře
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARCPALA_NOTIF_3_07"); //Není to ale nic co by se nedalo opravit, ty určitě na něco přijdeš.
	...
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Martin mi nabídl vyjímečnou zbroj paladina. Zní to jako zajímavá nabídka.");
};
//-------------------------------------
...
{
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Martin_ARKPALA_BOUGHT_4_1"); //Dobře, beru tu zbroj.

	if (B_GiveInvItems(other, self, ItMi_Gold, 2000))
	{
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARKPALA_BOUGHT_4_2"); //Dobře, tady ji máš.
			B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Koupil jsem si od Martina paladinskou zbroj. Je rezavá ale zkušený kovář by ji měl opravit, jenom najít nějakého kdo by byl ochotný to pro mně udělat.");

		Ninja_ArmorExpansion_Martin_ARKPALA_BOUGHT = B_GiveInvItems(self, other, Ninja_ArmorExpansion_ITAR_PAL_R, 1);
	}
	else
	{
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Martin_ARKPALA_BOUGHT_4_3"); //Přijď až budeš mít u sebe dost zlata
	};
};
...
func void Ninja_ArmorExpansion_DIA_MORTIS_PAL_REFORGE_Info ()
{
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_PAL_REFORGE_3_01"); //Nemohl, nemám na to čas ani zkušenosti.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MORTIS_PAL_REFORGE_3_02"); //Budeš si muset najít jiného kováře.
...
func void Ninja_ArmorExpansion_DIA_BENNET_PAL_REFORGE_Info ()
{
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_PAL_REFORGE_3_01"); //Promiň, ale nemohl.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_PAL_REFORGE_3_03"); //Nic proti tobě nemám, vždyť si mně dostal z vězení.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_PAL_REFORGE_3_04"); //Ale co by si pomyslely ostatní na farmě kdybych tu začal opravovat zbroje paladinů?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_BENNET_PAL_REFORGE_3_05"); //Budeš si muset najít jiného kováře.
...
func void Ninja_ArmorExpansion_DIA_CARL_PAL_REFORGE_Info ()
{
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_CARL_PAL_REFORGE_3_02"); //Promiň chlapče, ale to je nad moje síly.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_CARL_PAL_REFORGE_3_03"); //Budeš si muset najít jiného kováře.
...
func void Ninja_ArmorExpansion_DIA_JAN_PAL_REFORGE_Info ()
{
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_JAN_PAL_REFORGE_3_01"); //Jsem na tenkém ledě jenom abych tu mohl pracovat.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_JAN_PAL_REFORGE_3_02"); //Nehodlám riskovat že mně nějáký z tvých kolegů udá za to že se hrabu v paladinských věcech.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_JAN_PAL_REFORGE_3_03"); //Budeš si muset najít jiného kováře.
...
func void Ninja_ArmorExpansion_DIA_HUNO_PAL_REFORGE_Info ()
{
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HUNO_PAL_REFORGE_3_01"); //S paladinskými zbrojemi nemám vůbec žádné zkušenosti, nic takového v kolonii nebylo.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HUNO_PAL_REFORGE_3_02"); //Promiň, ale s tímhle ti nepomůžu.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HUNO_PAL_REFORGE_3_03"); //Budeš si muset najít jiného kováře.
...
func void Ninja_ArmorExpansion_DIA_HARAD_PAL_SHOW_Info ()
{
	...
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PAL_SHOW_3_02"); //Už je to dlouho co jsem takovou zbroj viděl.
	...
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PAL_SHOW_3_04"); //Rez nepronikla moc hluboko, nebude moc těžké ji opravit.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PAL_SHOW_3_05"); //Samozřejmě pokud budu mít potřebné materiály.
	...
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PAL_SHOW_3_07"); //Prodal mi ji Martin, válela se mezi paladinským vybavením tak jsem ji chtěl použít.
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_15_01"); //Takže, co budeš na opravu zbroje potřebovat?
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_02"); //Hmm, nech mně se zamyslet
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_04"); //Několik ocelových prutů, 6 by mělo stačit.
	...
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_07"); //Nic. Bude mi potěšením pracovat na takovém kousku.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_15_08"); //Dobrá, pokusím se to všechno sehnat.
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Na opravu zbroje bude Harad potřebovat 6 ocelových prutů a tři hrudky rudy.");
    ...
    && (Npc_HasItems(other, ItMi_Nugget) >= 3)
	{
        ...
        AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_15_10"); //A tady potřebné materiály.
		...
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_15"); //Na to budeš potřebovat zkušeného mága ohně, který je ochotný pro tebe zbroj posvětit.
        AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_15_14"); //Díky.
		B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Harad mi opravil paladinskou zbroj, ale nepodařilo se mu navrátit její magickou moc. Budu pro to muset najít ochotného mága ohně, jeden takový mně napadá.");
	}
	else
	{
	    AI_Output (self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_16"); //Přijď až to všechno seženeš.
	};
};
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_15_01"); //Potřebuji tvojí pomoc.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_02"); //O co jde?
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_04"); //Potřeboval bych navrátit magickou moc této zbroji, nedokázal by si to pro mně udělat?
	...
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_06"); //Páni, tohle jsem nečekal.
	...
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_07"); //O rituálu požehnání jsem něco málo už slyšel, ale nemám ještě dostatek znalostí abych ho provedl.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_07"); //Jestli se ale nepletu tak je zde v knihovně klášteru kniha která popisuje tento postup.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_07"); //Budu potřebovat nějáký čas si tu knihu nastudovat. Mezitím by si se ale měl postarat o draky v hornickém údolí, víš jak na tom je Garondova jednotka.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_15_08"); //Jasně, uvidíme se později Miltene.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_PALADIN_REFORGE_13_07"); //Hodně štěstí!
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Milten souhlasil že mi pomůže navrátit zbroji její magickou sílu, ale nejdříve si bude muset nastudovat postup rituálu. Nějáký čas mu to zabere takže mi řekl že se mám mezitím postarat o draky v hornickém údolí.");
};
instance Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR (C_INFO)
{
	npc			 =  PC_Mage_NW;
...
func void Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_Info ()
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_15_01"); //Potřebuji tvojí pomoc.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_02"); //O co jde?
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_04"); //Potřeboval bych navrátit magickou moc této zbroji, nedokázal by si to pro mně udělat?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_05"); //Ukaž mi ji
	B_GiveInvItems(other, self, Ninja_ArmorExpansion_ITAR_PAL_F, 1);
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_06"); //Páni, tohle jsem nečekal.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_07"); //Takové zbroje nosí paladiny z Myrtany požehnat do klášteru v Nordmaru.
		B_GiveInvItems(self, other, Ninja_ArmorExpansion_ITAR_PAL_F, 1);
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_08"); //O rituálu požehnání jsem něco málo už slyšel, ale nemám ještě dostatek znalostí abych ho provedl.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_09"); //Jestli se ale nepletu tak je zde v knihovně klášteru kniha která popisuje tento postup.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_10"); //Budu potřebovat nějáký čas si tu knihu nastudovat. Mezitím by si se ale měl postarat o draky v hornickém údolí, víš jak na tom je Garondova jednotka.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_15_11"); //Jasně, uvidíme se později Miltene.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PALADINARMOR_13_12"); //Hodně štěstí!
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Milten souhlasil že mi pomůže navrátit zbroji její magickou sílu, ale nejdříve si bude muset nastudovat postup rituálu. Nějáký čas mu to zabere takže mi řekl že se mám mezitím postarat o draky v hornickém údolí.");
};
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_15_01"); //Udělal si pokrok ve svých studiích?
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_13_02"); //Ano, dokážu říct že postupu rituálu rozumím.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_13_03"); //Ale budu potřebovat pár věcí
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_15_04"); //Jaké?
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_13_05"); //Svitek zničení zla, ohnivé koule a 2 kamenné krystaly.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_13_06"); //Jedině tak dokážu dosáhnout podobných výsledků jako při provedení rituálu v klášteru v Nordmaru
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_13_07"); //Dobrá, jdu sehnat ti věci.
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_PLATEARMOR_13_08"); //Hodně štěstí, doufám že se ti to povede.
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Milten Bude na rituál potřebovat svitek zničení zla, svitek ohnivé koule a 2 kamenné krystaly.");
};
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_MILTEN_RITUALARMOR_15_01"); //Mám vše co budeš potřebovat.
		B_GiveInvItems(other, self, Ninja_ArmorExpansion_ITAR_PAL_F, 1);
    ...
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_MILTEN_RITUALARMOR_13_02"); //Skvěle. Můžu začít s rituálem.
	B_LogEntry (NINJA_ARMOREXPANSION_TOPIC_MARTIN_ARMOR,"Donesl jsem Miltenovi všechno potřebné pro rituál.");
};
//-------------------------------------
...
func void Ninja_ArmorExpansion_DIA_MILTEN_LORDRMOR_Info()
{
	...
	&& (Npc_HasItems(self, Ninja_ArmorExpansion_ITAR_PAL_F) >= 1)
	{
		...
		{
			AI_Output (self, other, "Ninja_ArmorExpansion_DIA_MILTEN_LORDRMOR_08_01"); //Chvilku to potrvá, vrať se zítra.
		}
		else
		{
			...
			AI_Output (self, other, "Ninja_ArmorExpansion_DIA_MILTEN_LORDRMOR_08_03"); //Vše proběhlo překvapivě hladce.
			AI_Output (other, self, "Ninja_ArmorExpansion_DIA_MILTEN_LORDRMOR_15_04"); //To jsem rád, díky.
			AI_Output (self, other, "Ninja_ArmorExpansion_DIA_MILTEN_LORDRMOR_08_05"); //Nemáš za co, ať ti slouží.
...
{
    AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Bennet_CROSSBOW_15_01"); //Neměl by se pro mně lehčí zbroj?.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Bennet_CROSSBOW_15_02"); //Neber si to špatně, jsem za ní vděčný ale preferuji lehčí.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Bennet_CROSSBOW_13_03"); //Vlastně ano, jednu takovou jsem taky vytvořil, jestli chceš tak ti je můžu vyměnit.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_Bennet_CROSSBOW_15_04"); //Díky, Beru jí.
        ...
        AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Bennet_CROSSBOW_15_9");//Tady je, ať ti slouží.
};
...
{
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_END_MAKE_1"); //Nemohl by si mi překovat moji zbroj paladina?
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_END_MAKE_2"); //Určitě, ale nevím co by se ti na ní nelíbilo.
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_END_MAKE_3"); //Používám zbraně na dálku, tak bych ji chtěl odlehčit.
    AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_END_MAKE_4"); //To by nemělo být těžké, určitě bych to zvládl.
	...
	AI_Output(other, self, "Ninja_ArmorExpansion_DIA_HARAD_END_MAKE_7"); //Tady ji máš v tom případě.
	...
	AI_Output(self, other, "Ninja_ArmorExpansion_DIA_HARAD_END_MAKE_8"); //Hotovo, nebylo to nic těžkého. Tady je.
...
func void Ninja_ArmorExpansion_DIA_Bennet_PATCH_DJG_ARMOR_CM_Info ()
{
	...
	{
		AI_Output 	(self ,other,"Ninja_ArmorExpansion_DIA_Bennet_DJG_ARMOR_M_06_01"); //Skvěle. Bude se ti líbit.
		AI_Output	(other,self ,"Ninja_ArmorExpansion_DIA_Bennet_DJG_ARMOR_M_15_02"); //Za takovou cenu v to doufám.
		AI_Output 	(self ,other,"Ninja_ArmorExpansion_DIA_Bennet_DJG_ARMOR_M_06_03"); //Přesvedčíš se, že to za tu cenu stálo.
...
func void Ninja_ArmorExpansion_DIA_GAROND_KNIGHT_ARMORREWARD_Info ()
{
		...
		AI_Output (self,other,"Ninja_ArmorExpansion_DIA_GAROND_KNIGHT_ARMORREWARD_01_04"); //Jsi jediný z nás komu se zatím podařilo nějákého draka zabít.
		AI_Output (self,other,"Ninja_ArmorExpansion_DIA_GAROND_KNIGHT_ARMORREWARD_01_05"); //Mám naději že se ti povede je dostat všechny.
		B_GiveInvItems(self, other, Ninja_ArmorExpansion_ITAR_PAL_MH, 1);
		AI_Output (self,other,"Ninja_ArmorExpansion_DIA_GAROND_KNIGHT_ARMORREWARD_01_06"); //Tady máš, tohle by ti mělo pomoci ve tvém úkolu. A teď už běž, není moc času nazbyt.
...
{
	AI_Output	(other, self, "Ninja_ArmorExpansion_DIA_Addon_Greg_RavenDead_15_00"); //Co takhle nějáká lepší zbroj?
	...
	AI_Output	(other, self, "Ninja_ArmorExpansion_DIA_Addon_Greg_RavenDead_15_03"); //Takhle jsem to nemyslel. Kapitánem zůstaneš ty, jenom mi jde o tu zbroj.
	AI_Output	(self, other, "Ninja_ArmorExpansion_DIA_Addon_Greg_RavenDead_01_04"); //Dobrá, můžu ti prodat jeden z mých osobních kousků.
	AI_Output	(self, other, "Ninja_ArmorExpansion_DIA_Addon_Greg_RavenDead_01_05"); //Ale přijde tě to draho, chci za ní 2700 zlatých
...
func void Ninja_ArmorExpansion_DIA_Addon_Greg_BUY_ARMOREXPANSION_NINJA_Info ()
{
	...
	{
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Addon_Greg_BUY_ARMOREXPANSION_NINJA_4_2"); //Tady jí máš, ale pamatuj si že kapitánem zůstávám já.
		B_GiveInvItems(self, other, ITAR_PIR_H_ARMOREXPANSION, 1);
        Ninja_ArmorExpansion_ARMOREXPANSION_BOUGHT_CAPTAIN = TRUE;
	}
	else
	{
		AI_Output(self, other, "Ninja_ArmorExpansion_DIA_Addon_Greg_BUY_ARMOREXPANSION_NINJA_4_3"); //Vrať se až budeš mít u sebe dost zlata.
	};
};
