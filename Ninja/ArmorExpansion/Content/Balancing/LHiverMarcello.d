...
func void Patch_AE_BalanceLHiverMarcello() {
    ...
    ITAR_MIL_R_ArmorExpansion__PROT_EDGE = 50;
    ITAR_MIL_R_ArmorExpansion__PROT_BLUNT = 50;
    ITAR_MIL_R_ArmorExpansion__PROT_POINT = 25;
    ITAR_MIL_R_ArmorExpansion__PROT_FIRE = 5;
    ...
    ITAR_MIL_SCOUT_ArmorExpansion__PROT_POINT = 15;
    ITAR_MIL_SCOUT_ArmorExpansion__PROT_FIRE = 0;
    ITAR_MIL_SCOUT_ArmorExpansion__PROT_MAGIC = 0;

    ITAR_MIL_M_ArmorExpansion__PROT_EDGE = 55;
    ITAR_MIL_M_ArmorExpansion__PROT_BLUNT = 55;
    ITAR_MIL_M_ArmorExpansion__PROT_POINT = 30;
    ...
    ITAR_MIL_P_ArmorExpansion__PROT_POINT = 25;
    ITAR_MIL_P_ArmorExpansion__PROT_FIRE = 5;
    ITAR_MIL_P_ArmorExpansion__PROT_MAGIC = 0;

    ITAR_MIL_MED2_ArmorExpansion__PROT_EDGE = 65;
    ITAR_MIL_MED2_ArmorExpansion__PROT_BLUNT = 65;
    ITAR_MIL_MED2_ArmorExpansion__PROT_POINT = 40;
    ITAR_MIL_MED2_ArmorExpansion__PROT_FIRE = 10;
    ITAR_MIL_MED2_ArmorExpansion__PROT_MAGIC = 5;

    ITAR_MILP_H_ArmorExpansion__PROT_EDGE = 80;
    ITAR_MILP_H_ArmorExpansion__PROT_BLUNT = 80;
    ITAR_MILP_H_ArmorExpansion__PROT_POINT = 40;
    ITAR_MILP_H_ArmorExpansion__PROT_FIRE = 10;
    ITAR_MILP_H_ArmorExpansion__PROT_MAGIC = 5;

    ITAR_MIL_H_ArmorExpansion__PROT_EDGE = 90;
    ITAR_MIL_H_ArmorExpansion__PROT_BLUNT = 90;
    ITAR_MIL_H_ArmorExpansion__PROT_POINT = 50;
    ITAR_MIL_H_ArmorExpansion__PROT_FIRE = 15;
    ITAR_MIL_H_ArmorExpansion__PROT_MAGIC = 5;

    // SLD

    ITAR_SLD_LR_ArmorExpansion__PROT_EDGE = 50;
    ITAR_SLD_LR_ArmorExpansion__PROT_BLUNT = 50;
    ITAR_SLD_LR_ArmorExpansion__PROT_POINT = 15;
    ITAR_SLD_LR_ArmorExpansion__PROT_FIRE = 0;
    ITAR_SLD_LR_ArmorExpansion__PROT_MAGIC = 0;

    ITAR_SLD_SCOUT_ArmorExpansion__PROT_EDGE = 30;
    ITAR_SLD_SCOUT_ArmorExpansion__PROT_BLUNT = 30;
    ITAR_SLD_SCOUT_ArmorExpansion__PROT_POINT = 5;
    ...
    ITAR_SLD_R_ArmorExpansion__PROT_POINT = 30;
    ITAR_SLD_R_ArmorExpansion__PROT_FIRE = 10;
    ITAR_SLD_R_ArmorExpansion__PROT_MAGIC = 10;

    ITAR_SLD_MP_ArmorExpansion__PROT_EDGE = 50;
    ITAR_SLD_MP_ArmorExpansion__PROT_BLUNT = 50;
    ITAR_SLD_MP_ArmorExpansion__PROT_POINT = 15;
    ITAR_SLD_MP_ArmorExpansion__PROT_FIRE = 5;
    ITAR_SLD_MP_ArmorExpansion__PROT_MAGIC = 5;

    ITAR_SLD_BOW_ArmorExpansion__PROT_EDGE = 75;
    ITAR_SLD_BOW_ArmorExpansion__PROT_BLUNT = 80;
    ITAR_SLD_BOW_ArmorExpansion__PROT_POINT = 30;
    ...
    ItAr_KDF_M_AMEXPANSION__PROT_FIRE = 50;
    ItAr_KDF_M_AMEXPANSION__PROT_MAGIC = 50;
    ...
    ITAR_DJG_CH_ArmorExpansion__PROT_FIRE = 95;
	...
	ITAR_DJG_M2_ArmorExpansion__PROT_MAGIC = 40;
	...
	ITAR_DJG_M2_NH_ArmorExpansion__PROT_MAGIC = 40;
	...
	ITAR_PAL_ST_NH_ArmorExpansion__PROT_EDGE = 100;
    ITAR_PAL_ST_NH_ArmorExpansion__PROT_BLUNT = 90;
    ITAR_PAL_ST_NH_ArmorExpansion__PROT_POINT = 70;
    ...
    ITAR_GAMBESON_ArmorExpansion__PROT_FIRE = 5;
    ITAR_GAMBESON_ArmorExpansion__PROT_MAGIC = 5;

    ITAR_ARX_HUNTERM_ArmorExpansion__PROT_EDGE = 40;
    ITAR_ARX_HUNTERM_ArmorExpansion__PROT_BLUNT = 40;
    ITAR_ARX_HUNTERM_ArmorExpansion__PROT_POINT = 20;
    ITAR_ARX_HUNTERM_ArmorExpansion__PROT_FIRE = 10;
    ITAR_ARX_HUNTERM_ArmorExpansion__PROT_MAGIC = 10;

    ITAR_ARX_HUNTERH_ArmorExpansion__PROT_EDGE = 55;
    ITAR_ARX_HUNTERH_ArmorExpansion__PROT_BLUNT = 55;
    ITAR_ARX_HUNTERH_ArmorExpansion__PROT_POINT = 30;
