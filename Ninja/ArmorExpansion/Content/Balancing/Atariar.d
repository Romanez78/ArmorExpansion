...
func void Patch_AE_BalanceAtariar() {
    ...
    ITAR_MIL_MED2_ArmorExpansion__PROT_EDGE = 60;
    ITAR_MIL_MED2_ArmorExpansion__PROT_BLUNT = 60;
    ITAR_MIL_MED2_ArmorExpansion__PROT_POINT = 60;
    ITAR_MIL_MED2_ArmorExpansion__PROT_FIRE = 10;
    ITAR_MIL_MED2_ArmorExpansion__PROT_MAGIC = 5;

    ITAR_MILP_H_ArmorExpansion__PROT_EDGE = 65;
    ITAR_MILP_H_ArmorExpansion__PROT_BLUNT = 65;
    ITAR_MILP_H_ArmorExpansion__PROT_POINT = 65;
    ITAR_MILP_H_ArmorExpansion__PROT_FIRE = 5;
    ITAR_MILP_H_ArmorExpansion__PROT_MAGIC = 5;

    ITAR_MIL_H_ArmorExpansion__PROT_EDGE = 70;
    ITAR_MIL_H_ArmorExpansion__PROT_BLUNT = 70;
    ITAR_MIL_H_ArmorExpansion__PROT_POINT = 70;
    ...
    ITAR_SLD_R_ArmorExpansion__PROT_EDGE = 65;
    ITAR_SLD_R_ArmorExpansion__PROT_BLUNT = 65;
    ITAR_SLD_R_ArmorExpansion__PROT_POINT = 65;
    ...
    ITAR_SLD_BOW_ArmorExpansion__PROT_EDGE = 70;
    ITAR_SLD_BOW_ArmorExpansion__PROT_BLUNT = 75;
    ITAR_SLD_BOW_ArmorExpansion__PROT_POINT = 70;
    ...
    ITAR_PAL_MH_ArmorExpansion__PROT_EDGE = 125;
    ITAR_PAL_MH_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_PAL_MH_ArmorExpansion__PROT_POINT = 120;
    ITAR_PAL_MH_ArmorExpansion__PROT_FIRE = 70;
    ITAR_PAL_MH_ArmorExpansion__PROT_MAGIC = 35;

    ITAR_PAL_MH_FH_ArmorExpansion__PROT_EDGE = 125;
    ITAR_PAL_MH_FH_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_PAL_MH_FH_ArmorExpansion__PROT_POINT = 120;
    ITAR_PAL_MH_FH_ArmorExpansion__PROT_FIRE = 70;
    ITAR_PAL_MH_FH_ArmorExpansion__PROT_MAGIC = 35;

    ITAR_PAL_C_ArmorExpansion__PROT_EDGE = 95;
    ...
    ITAR_PAL_CM_ArmorExpansion__PROT_EDGE = 115;
    ITAR_PAL_CM_ArmorExpansion__PROT_BLUNT = 110;
    ITAR_PAL_CM_ArmorExpansion__PROT_POINT = 110;
    ITAR_PAL_CM_ArmorExpansion__PROT_FIRE = 60;
    ITAR_PAL_CM_ArmorExpansion__PROT_MAGIC = 30;

    ITAR_PAL_CH_ArmorExpansion__PROT_EDGE = 135;
    ITAR_PAL_CH_ArmorExpansion__PROT_BLUNT = 130;
    ITAR_PAL_CH_ArmorExpansion__PROT_POINT = 130;
    ITAR_PAL_CH_ArmorExpansion__PROT_FIRE = 80;
    ITAR_PAL_CH_ArmorExpansion__PROT_MAGIC = 40;

    ITAR_CRUSADER_ArmorExpansion__PROT_EDGE = 115;
    ITAR_CRUSADER_ArmorExpansion__PROT_BLUNT = 110;
    ITAR_CRUSADER_ArmorExpansion__PROT_POINT = 110;
    ITAR_CRUSADER_ArmorExpansion__PROT_FIRE = 65;
    ITAR_CRUSADER_ArmorExpansion__PROT_MAGIC = 35;

    ITAR_NH_CRUSADER_ArmorExpansion__PROT_EDGE = 115;
    ITAR_NH_CRUSADER_ArmorExpansion__PROT_BLUNT = 110;
    ITAR_NH_CRUSADER_ArmorExpansion__PROT_POINT = 110;
    ITAR_NH_CRUSADER_ArmorExpansion__PROT_FIRE = 65;
    ITAR_NH_CRUSADER_ArmorExpansion__PROT_MAGIC = 35;

    ITAR_PAL_A_ArmorExpansion__PROT_EDGE = 140;
    ITAR_PAL_A_ArmorExpansion__PROT_BLUNT = 135;
    ITAR_PAL_A_ArmorExpansion__PROT_POINT = 135;
    ITAR_PAL_A_ArmorExpansion__PROT_FIRE = 110;
    ITAR_PAL_A_ArmorExpansion__PROT_MAGIC = 70;
    Patch_AE_ITAR_PAL_A_BONUS_MANA = 40;

    ITAR_PAL_AFH_ArmorExpansion__PROT_EDGE = 140;
    ITAR_PAL_AFH_ArmorExpansion__PROT_BLUNT = 135;
    ITAR_PAL_AFH_ArmorExpansion__PROT_POINT = 135;
    ITAR_PAL_AFH_ArmorExpansion__PROT_FIRE = 110;
    ITAR_PAL_AFH_ArmorExpansion__PROT_MAGIC = 70;

    ITAR_PAL_ANH_ArmorExpansion__PROT_EDGE = 140;
    ITAR_PAL_ANH_ArmorExpansion__PROT_BLUNT = 135;
    ITAR_PAL_ANH_ArmorExpansion__PROT_POINT = 135;
    ITAR_PAL_ANH_ArmorExpansion__PROT_FIRE = 110;
    ITAR_PAL_ANH_ArmorExpansion__PROT_MAGIC = 70;

    ITAR_PAL_F_ArmorExpansion__PROT_EDGE = 125;
    ITAR_PAL_F_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_PAL_F_ArmorExpansion__PROT_POINT = 120;
    ITAR_PAL_F_ArmorExpansion__PROT_FIRE = 75;
    ITAR_PAL_F_ArmorExpansion__PROT_MAGIC = 45;
    Patch_AE_ITAR_PAL_F_BONUS_MANA = 20;

    ITAR_PAL_FFH_ArmorExpansion__PROT_EDGE = 125;
    ITAR_PAL_FFH_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_PAL_FFH_ArmorExpansion__PROT_POINT = 120;
    ITAR_PAL_FFH_ArmorExpansion__PROT_FIRE = 75;
    ITAR_PAL_FFH_ArmorExpansion__PROT_MAGIC = 45;

    ITAR_PAL_FNH_ArmorExpansion__PROT_EDGE = 125;
    ITAR_PAL_FNH_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_PAL_FNH_ArmorExpansion__PROT_POINT = 120;
    ITAR_PAL_FNH_ArmorExpansion__PROT_FIRE = 75;
    ITAR_PAL_FNH_ArmorExpansion__PROT_MAGIC = 45;

    ITAR_PAL_R_ArmorExpansion__PROT_EDGE = 90;
    ...
    ITAR_PAL_RFH_ArmorExpansion__PROT_EDGE = 90;
    ...
    ITAR_PAL_RNH_ArmorExpansion__PROT_EDGE = 90;
    ...
    ITAR_PAL_HFH_ArmorExpansion__PROT_EDGE = 145;
    ITAR_PAL_HFH_ArmorExpansion__PROT_BLUNT = 140;
    ITAR_PAL_HFH_ArmorExpansion__PROT_POINT = 140;
    ITAR_PAL_HFH_ArmorExpansion__PROT_FIRE = 90;
    ITAR_PAL_HFH_ArmorExpansion__PROT_MAGIC = 50;

    ITAR_PAL_HNH_ArmorExpansion__PROT_EDGE = 145;
    ITAR_PAL_HNH_ArmorExpansion__PROT_BLUNT = 140;
    ITAR_PAL_HNH_ArmorExpansion__PROT_POINT = 140;
    ITAR_PAL_HNH_ArmorExpansion__PROT_FIRE = 90;
    ITAR_PAL_HNH_ArmorExpansion__PROT_MAGIC = 50;

    ITAR_PAL_CH_FH_ArmorExpansion__PROT_EDGE = 135;
    ITAR_PAL_CH_FH_ArmorExpansion__PROT_BLUNT = 130;
    ITAR_PAL_CH_FH_ArmorExpansion__PROT_POINT = 130;
    ITAR_PAL_CH_FH_ArmorExpansion__PROT_FIRE = 80;
    ITAR_PAL_CH_FH_ArmorExpansion__PROT_MAGIC = 40;

    ITAR_PAL_CM_FH_ArmorExpansion__PROT_EDGE = 115;
    ITAR_PAL_CM_FH_ArmorExpansion__PROT_BLUNT = 110;
    ITAR_PAL_CM_FH_ArmorExpansion__PROT_POINT = 110;
    ITAR_PAL_CM_FH_ArmorExpansion__PROT_FIRE = 60;
    ITAR_PAL_CM_FH_ArmorExpansion__PROT_MAGIC = 30;

    ITAR_PAL_M_NH_ArmorExpansion__PROT_EDGE = 105;
    ...
    ITAR_PAL_M_NH_ArmorExpansion__PROT_MAGIC = 25;
    ...
    ITAR_DJG_CL_ArmorExpansion__PROT_FIRE = 45;
    ITAR_DJG_CL_ArmorExpansion__PROT_MAGIC = 15;

    ITAR_DJG_CM_ArmorExpansion__PROT_EDGE = 115;
    ITAR_DJG_CM_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_DJG_CM_ArmorExpansion__PROT_POINT = 115;
    ITAR_DJG_CM_ArmorExpansion__PROT_FIRE = 70;
    ITAR_DJG_CM_ArmorExpansion__PROT_MAGIC = 20;

    ITAR_DJG_CH_ArmorExpansion__PROT_EDGE = 150;
    ITAR_DJG_CH_ArmorExpansion__PROT_BLUNT = 150;
    ITAR_DJG_CH_ArmorExpansion__PROT_POINT = 150;
    ITAR_DJG_CH_ArmorExpansion__PROT_FIRE = 90;
    ITAR_DJG_CH_ArmorExpansion__PROT_MAGIC = 40;

    ITAR_DJG_CrawlerP_AEXPANSION__PROT_EDGE = 80;
    ITAR_DJG_CrawlerP_AEXPANSION__PROT_BLUNT = 60;
    ITAR_DJG_CrawlerP_AEXPANSION__PROT_POINT = 80;
    ITAR_DJG_CrawlerP_AEXPANSION__PROT_FIRE = 30;
    ITAR_DJG_CrawlerP_AEXPANSION__PROT_MAGIC = 10;

    ITAR_DJG_H2_ArmorExpansion__PROT_EDGE = 165;
    ITAR_DJG_H2_ArmorExpansion__PROT_BLUNT = 165;
    ITAR_DJG_H2_ArmorExpansion__PROT_POINT = 165;
    ITAR_DJG_H2_ArmorExpansion__PROT_FIRE = 105;
    ITAR_DJG_H2_ArmorExpansion__PROT_MAGIC = 50;

    ITAR_DJG_M2_ArmorExpansion__PROT_EDGE = 135;
    ITAR_DJG_M2_ArmorExpansion__PROT_BLUNT = 135;
    ITAR_DJG_M2_ArmorExpansion__PROT_POINT = 135;
    ITAR_DJG_M2_ArmorExpansion__PROT_FIRE = 85;
    ITAR_DJG_M2_ArmorExpansion__PROT_MAGIC = 35;

    ITAR_DJG_L2_ArmorExpansion__PROT_EDGE = 110;
    ITAR_DJG_L2_ArmorExpansion__PROT_BLUNT = 115;
    ITAR_DJG_L2_ArmorExpansion__PROT_POINT = 110;
    ITAR_DJG_L2_ArmorExpansion__PROT_FIRE = 60;
    ITAR_DJG_L2_ArmorExpansion__PROT_MAGIC = 30;

    ITAR_DJG_H2_NH_ArmorExpansion__PROT_EDGE = 165;
    ITAR_DJG_H2_NH_ArmorExpansion__PROT_BLUNT = 165;
    ITAR_DJG_H2_NH_ArmorExpansion__PROT_POINT = 165;
    ITAR_DJG_H2_NH_ArmorExpansion__PROT_FIRE = 105;
    ITAR_DJG_H2_NH_ArmorExpansion__PROT_MAGIC = 50;

    ITAR_DJG_M2_NH_ArmorExpansion__PROT_EDGE = 135;
    ITAR_DJG_M2_NH_ArmorExpansion__PROT_BLUNT = 135;
    ITAR_DJG_M2_NH_ArmorExpansion__PROT_POINT = 135;
    ITAR_DJG_M2_NH_ArmorExpansion__PROT_FIRE = 85;
    ITAR_DJG_M2_NH_ArmorExpansion__PROT_MAGIC = 35;

    ITAR_DJG_L2_NH_ArmorExpansion__PROT_EDGE = 110;
    ITAR_DJG_L2_NH_ArmorExpansion__PROT_BLUNT = 115;
    ITAR_DJG_L2_NH_ArmorExpansion__PROT_POINT = 110;
    ITAR_DJG_L2_NH_ArmorExpansion__PROT_FIRE = 60;
    ITAR_DJG_L2_NH_ArmorExpansion__PROT_MAGIC = 30;

    ITAR_DJG_L_FH_ArmorExpansion__PROT_EDGE = 100;
    ITAR_DJG_L_FH_ArmorExpansion__PROT_BLUNT = 105;
    ITAR_DJG_L_FH_ArmorExpansion__PROT_POINT = 100;
    ITAR_DJG_L_FH_ArmorExpansion__PROT_FIRE = 50;
    ITAR_DJG_L_FH_ArmorExpansion__PROT_MAGIC = 25;

    ITAR_DJG_CH_FH_ArmorExpansion__PROT_EDGE = 150;
    ITAR_DJG_CH_FH_ArmorExpansion__PROT_BLUNT = 150;
    ITAR_DJG_CH_FH_ArmorExpansion__PROT_POINT = 150;
    ITAR_DJG_CH_FH_ArmorExpansion__PROT_FIRE = 90;
    ITAR_DJG_CH_FH_ArmorExpansion__PROT_MAGIC = 40;

    ITAR_DJG_CM_FH_ArmorExpansion__PROT_EDGE = 115;
    ITAR_DJG_CM_FH_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_DJG_CM_FH_ArmorExpansion__PROT_POINT = 115;
    ITAR_DJG_CM_FH_ArmorExpansion__PROT_FIRE = 70;
    ITAR_DJG_CM_FH_ArmorExpansion__PROT_MAGIC = 20;

    // Guildless

    ITAR_PAL_ST_ArmorExpansion__PROT_EDGE = 95;
