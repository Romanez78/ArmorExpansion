func int Patch_AE_IsShieldsMod() {
    return (Hlp_StrCmp(NINJA_MODNAME, "USCS_SHIELDS_MOD_CZ"));
};

func void Patch_AE_BalanceShieldsMod() {
    ...
    ITAR_SLD_R_ArmorExpansion__PROT_MAGIC = 5;
    ...
    ItAr_KDF_M_AMEXPANSION__PROT_EDGE = 60;
    ItAr_KDF_M_AMEXPANSION__PROT_BLUNT = 60;
    ItAr_KDF_M_AMEXPANSION__PROT_POINT = 60;
    ItAr_KDF_M_AMEXPANSION__PROT_FIRE = 40;
    ItAr_KDF_M_AMEXPANSION__PROT_MAGIC = 40;

    // PAL

    ITAR_PAL_MH_ArmorExpansion__PROT_EDGE = 120;
    ...
    ITAR_PAL_MH_FH_ArmorExpansion__PROT_EDGE = 120;
    ...
    ITAR_PAL_CM_ArmorExpansion__PROT_EDGE = 110;
    ...
    ITAR_PAL_CH_ArmorExpansion__PROT_EDGE = 140;
    ITAR_PAL_CH_ArmorExpansion__PROT_BLUNT = 140;
    ITAR_PAL_CH_ArmorExpansion__PROT_POINT = 140;
    ITAR_PAL_CH_ArmorExpansion__PROT_FIRE = 90;
    ITAR_PAL_CH_ArmorExpansion__PROT_MAGIC = 45;
    ...
    ITAR_PAL_A_ArmorExpansion__PROT_EDGE = 145;
    ITAR_PAL_A_ArmorExpansion__PROT_BLUNT = 145;
    ITAR_PAL_A_ArmorExpansion__PROT_POINT = 145;
    ITAR_PAL_A_ArmorExpansion__PROT_FIRE = 120;
    ITAR_PAL_A_ArmorExpansion__PROT_MAGIC = 70;
    Patch_AE_ITAR_PAL_A_BONUS_MANA = 40;

    ITAR_PAL_AFH_ArmorExpansion__PROT_EDGE = 145;
    ITAR_PAL_AFH_ArmorExpansion__PROT_BLUNT = 145;
    ITAR_PAL_AFH_ArmorExpansion__PROT_POINT = 145;
    ITAR_PAL_AFH_ArmorExpansion__PROT_FIRE = 120;
    ITAR_PAL_AFH_ArmorExpansion__PROT_MAGIC = 70;

    ITAR_PAL_ANH_ArmorExpansion__PROT_EDGE = 145;
    ITAR_PAL_ANH_ArmorExpansion__PROT_BLUNT = 145;
    ITAR_PAL_ANH_ArmorExpansion__PROT_POINT = 145;
    ITAR_PAL_ANH_ArmorExpansion__PROT_FIRE = 120;
    ITAR_PAL_ANH_ArmorExpansion__PROT_MAGIC = 70;

    ITAR_PAL_F_ArmorExpansion__PROT_EDGE = 120;
    ...
    ITAR_PAL_FFH_ArmorExpansion__PROT_EDGE = 120;
    ...
    ITAR_PAL_FNH_ArmorExpansion__PROT_EDGE = 120;
    ...
    ITAR_PAL_HFH_ArmorExpansion__PROT_EDGE = 150;
    ITAR_PAL_HFH_ArmorExpansion__PROT_BLUNT = 150;
    ITAR_PAL_HFH_ArmorExpansion__PROT_POINT = 150;
    ITAR_PAL_HFH_ArmorExpansion__PROT_FIRE = 100;
    ITAR_PAL_HFH_ArmorExpansion__PROT_MAGIC = 50;

    ITAR_PAL_HNH_ArmorExpansion__PROT_EDGE = 150;
    ITAR_PAL_HNH_ArmorExpansion__PROT_BLUNT = 150;
    ITAR_PAL_HNH_ArmorExpansion__PROT_POINT = 150;
    ...
    ITAR_DJG_CM_ArmorExpansion__PROT_EDGE = 110;
    ITAR_DJG_CM_ArmorExpansion__PROT_BLUNT = 110;
    ITAR_DJG_CM_ArmorExpansion__PROT_POINT = 110;
    ITAR_DJG_CM_ArmorExpansion__PROT_FIRE = 70;
    ITAR_DJG_CM_ArmorExpansion__PROT_MAGIC = 20;

    ITAR_DJG_CH_ArmorExpansion__PROT_EDGE = 120;
    ITAR_DJG_CH_ArmorExpansion__PROT_BLUNT = 120;
    ITAR_DJG_CH_ArmorExpansion__PROT_POINT = 120;
    ITAR_DJG_CH_ArmorExpansion__PROT_FIRE = 80;
    ITAR_DJG_CH_ArmorExpansion__PROT_MAGIC = 30;
    ...
    ITAR_DJG_H2_ArmorExpansion__PROT_EDGE = 135;
	ITAR_DJG_H2_ArmorExpansion__PROT_BLUNT = 135;
	ITAR_DJG_H2_ArmorExpansion__PROT_POINT = 135;
	ITAR_DJG_H2_ArmorExpansion__PROT_FIRE = 90;
	ITAR_DJG_H2_ArmorExpansion__PROT_MAGIC = 40;

	ITAR_DJG_M2_ArmorExpansion__PROT_EDGE = 125;
	ITAR_DJG_M2_ArmorExpansion__PROT_BLUNT = 125;
	ITAR_DJG_M2_ArmorExpansion__PROT_POINT = 125;
	...
	ITAR_DJG_L2_ArmorExpansion__PROT_MAGIC = 25;

	ITAR_DJG_H2_NH_ArmorExpansion__PROT_EDGE = 135;
	ITAR_DJG_H2_NH_ArmorExpansion__PROT_BLUNT = 135;
	ITAR_DJG_H2_NH_ArmorExpansion__PROT_POINT = 135;
	ITAR_DJG_H2_NH_ArmorExpansion__PROT_FIRE = 90;
	ITAR_DJG_H2_NH_ArmorExpansion__PROT_MAGIC = 40;

	ITAR_DJG_M2_NH_ArmorExpansion__PROT_EDGE = 125;
	ITAR_DJG_M2_NH_ArmorExpansion__PROT_BLUNT = 125;
	ITAR_DJG_M2_NH_ArmorExpansion__PROT_POINT = 125;
	...
	ITAR_DJG_L2_NH_ArmorExpansion__PROT_MAGIC = 25;
	...
	ITAR_DJG_CH_FH_ArmorExpansion__PROT_EDGE = 120;
	ITAR_DJG_CH_FH_ArmorExpansion__PROT_BLUNT = 120;
	ITAR_DJG_CH_FH_ArmorExpansion__PROT_POINT = 120;
	ITAR_DJG_CH_FH_ArmorExpansion__PROT_FIRE = 80;
	ITAR_DJG_CH_FH_ArmorExpansion__PROT_MAGIC = 30;
    ...
    ITAR_PAL_ST_NH_ArmorExpansion__PROT_MAGIC = 15;
