...
instance Patch_AE_DIA_HUNO_PALNH_REFORGE (C_INFO)
{
    npc          =  BDT_1099_Addon_Huno;
    nr           =  3;
    condition    =  Patch_AE_DIA_HUNO_PALNH_REFORGE_Condition;
    information  =  Patch_AE_DIA_HUNO_PAL_REFORGE_Info;
    permanent    =  FALSE;
    description  =  Patch_AE_DIA_HUNO_PAL_REFORGE_desc;
};
func int Patch_AE_DIA_HUNO_PALNH_REFORGE_Condition()
{
...
instance Patch_AE_DIA_HUNO_PALFH_REFORGE (C_INFO)
{
    npc          =  BDT_1099_Addon_Huno;
    nr           =  3;
    condition    =  Patch_AE_DIA_HUNO_PALFH_REFORGE_Condition;
    information  =  Patch_AE_DIA_HUNO_PAL_REFORGE_Info;
    permanent    =  FALSE;
    description  =  Patch_AE_DIA_HUNO_PAL_REFORGE_desc;
};
func int Patch_AE_DIA_HUNO_PALFH_REFORGE_Condition()
{
