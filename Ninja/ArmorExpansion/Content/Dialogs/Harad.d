...
{
    if (Patch_AE_Martin_ARKPALA_BOUGHT == TRUE)
    {
        return TRUE;
    };
};
...
func int Patch_AE_DIA_HARAD_PALADIN_REFORGE_Condition()
{
    ...
    && (Npc_HasItems(other, ITAR_PAL_R_ArmorExpansion) > 0)
    {
        return TRUE;
    };
};
...
instance Patch_AE_DIA_HARAD_PALADIN_REFORGE_FH (C_INFO)
{
    npc          =  VLK_412_Harad;
    nr           =  8;
    condition    =  Patch_AE_DIA_HARAD_PALADIN_REFORGE_FH_Condition;
    information  =  Patch_AE_DIA_HARAD_PALADIN_REFORGE_FH_Info;
    permanent    =  TRUE;
    description  =  Patch_AE_DIA_HARAD_PALADIN_REFORGE_desc;
};
func int Patch_AE_DIA_HARAD_PALADIN_REFORGE_FH_Condition()
{
    if (Patch_AE_HARAD_PALADIN_REFORGEBought == FALSE)
    && (Npc_KnowsInfo (other, Patch_AE_DIA_HARAD_PAL_SHOW))
...
func void Patch_AE_DIA_HARAD_PALADIN_REFORGE_FH_Info()
{
    AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_01);
    AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_02);
    AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_04);
    ...
    if (Npc_HasItems(other, ITAR_PAL_RFH_ArmorExpansion) > 0)
    && (Npc_HasItems(other, Patch_AE_SmithItemCold) >= 6)
    && (Npc_HasItems(other, ItMi_Nugget) >= 3)
    {
        B_GivePlayerXP(100);
        B_GiveInvItems(other, self, ITAR_PAL_RFH_ArmorExpansion, 1);
        AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_9);
        B_GiveInvItems(other, self, Patch_AE_SmithItemCold, 6);
        B_GiveInvItems(other, self, ItMi_Nugget, 2);
        AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_10);
        ...
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_12);
        Patch_AE_HARAD_PALADIN_REFORGEBought = B_GiveInvItems(self, other, ITAR_PAL_FFH_ARMOREXPANSION, 1);
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_13);
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_14);
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_15);
        AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_14);
...
instance Patch_AE_DIA_HARAD_PALADIN_REFORGE_NH (C_INFO)
{
    npc          =  VLK_412_Harad;
    nr           =  8;
    condition    =  Patch_AE_DIA_HARAD_PALADIN_REFORGE_NH_Condition;
    information  =  Patch_AE_DIA_HARAD_PALADIN_REFORGE_NH_Info;
    permanent    =  TRUE;
    description  =  Patch_AE_DIA_HARAD_PALADIN_REFORGE_desc;
};
func int Patch_AE_DIA_HARAD_PALADIN_REFORGE_NH_Condition()
{
    if (Patch_AE_HARAD_PALADIN_REFORGEBought == FALSE)
    && (Npc_KnowsInfo (other, Patch_AE_DIA_HARAD_PAL_SHOW))
...
func void Patch_AE_DIA_HARAD_PALADIN_REFORGE_NH_Info()
{
    AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_01);
    AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_02);
    AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_04);
    ...
    if (Npc_HasItems(other, ITAR_PAL_RNH_ArmorExpansion) > 0)
    && (Npc_HasItems(other, Patch_AE_SmithItemCold) >= 6)
    && (Npc_HasItems(other, ItMi_Nugget) >= 3)
    {
        B_GivePlayerXP(100);
        B_GiveInvItems(other, self, ITAR_PAL_RNH_ArmorExpansion, 1);
        AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_9);
        B_GiveInvItems(other, self, Patch_AE_SmithItemCold, 6);
        B_GiveInvItems(other, self, ItMi_Nugget, 2);
        AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_10);
        ...
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_12);
        Patch_AE_HARAD_PALADIN_REFORGEBought = B_GiveInvItems(self, other, ITAR_PAL_FNH_ARMOREXPANSION, 1);
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_13);
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_14);
        AI_Output(self, other, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_13_15);
        AI_Output(other, self, PATCH_AE_DIA_HARAD_PALADIN_REFORGE_15_14);
