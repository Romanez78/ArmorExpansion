func void Patch_AE_LocalizeEnglish() {
    ...
    // AI_Output(self, other, "PATCH_AE_DIA_ANDRE_MIL_SCOUTARMOR_13_03_EN"); //I can give you the light crossbowman armor. It's lighter, so you'll be more agile, but also more vulnerable.
    ...
    PATCH_AE_DIA_Gorax_KDFM_ASK_3_05 = "PATCH_AE_DIA_Gorax_KDFM_ASK_3_05_EN";
    ...
    Patch_AE_PC_ITAR_PAL_M_NH_ARMOREXPANSION_desc = "Return chain coif of the knight armor";
    Patch_AE_PC_ITAR_PAL_M_desc = "Remove chain coif of the knight armor";
    ...
    Patch_AE_PC_ITAR_DJG_L_FH_ARMOREXPANSION_desc = "Remove helmet of the light dragonhunter armor";
    Patch_AE_PC_ITAR_DJG_L_desc = "Return helmet of the light dragonhunter armor";
    Patch_AE_PC_ITAR_DJG_CM_FH_ArmorExpansion_desc = "Remove helmet of the medium dragontracker armor";
    Patch_AE_PC_ITAR_DJG_CM_ArmorExpansion_desc = "Return helmet of the medium dragontracker armor";
    Patch_AE_PC_ITAR_DJG_CH_FH_ArmorExpansion_desc = "Remove helmet of the heavy dragontracker armor";
    Patch_AE_PC_ITAR_DJG_CH_ArmorExpansion_desc = "Return helmet of the heavy dragontracker armor";
    Patch_AE_PC_ITAR_PAL_CM_FH_ArmorExpansion_desc = "Remove helmet of the medium crossbowman paladin armor";
    Patch_AE_PC_ITAR_PAL_CM_ArmorExpansion_desc = "Return helmet of the medium crossbowman paladin armor";
